    ...
    if (isDelivered && order.deliveredAt) {
        ...
        if (daysSince <= 14) {
            actionBtnHtml = '<div style="margin-top: var(--space-4); padding-top: var(--space-4); border-top: 1px solid var(--border-light);">' +
                '<a href="https://api.whatsapp.com/send?phone=96550683207&text=' + msg + '" target="_blank" rel="noopener" style="display:block;text-align:center;background:#25d366;color:#fff;padding:12px;border-radius:6px;text-decoration:none;font-weight:500;">' +
        ...
        actionBtnHtml = '<div style="margin-top: var(--space-4); padding-top: var(--space-4); border-top: 1px solid var(--border-light);">' +
            '<a href="https://api.whatsapp.com/send?phone=96550683207&text=' + msg + '" target="_blank" rel="noopener" style="display:block;text-align:center;background:#ef4444;color:#fff;padding:12px;border-radius:6px;text-decoration:none;font-weight:500;">' +
...
function renderOrders(orders) {
    ...
    ordersList.innerHTML = orders.map(function(order) {
        ...
        if (isDelivered && order.deliveredAt) {
            ...
            const msg = encodeURIComponent('Hello ART\u00c9VA Maison,\n\nI would like to return/exchange:\n\nOrder #: ' + order.orderNumber + '\nItems: ' + itemNames + '\nTotal: ' + total + ' KWD\n\nReason: ');
            if (daysSince <= 14) {
                whatsappBtn = '<a href="https://api.whatsapp.com/send?phone=96550683207&text=' + msg + '" target="_blank" rel="noopener" class="btn-view-order" style="background:#25d366;color:#fff;font-size:12px;">\u21a9 Return (' + daysLeft + 'd left)</a>';
            } else {
            ...
            const msg = encodeURIComponent('Hello ART\u00c9VA Maison,\n\nI would like to cancel:\n\nOrder #: ' + order.orderNumber + '\nItems: ' + itemNames + '\nTotal: ' + total + ' KWD\n\nReason: ');
            whatsappBtn = '<a href="https://api.whatsapp.com/send?phone=96550683207&text=' + msg + '" target="_blank" rel="noopener" class="btn-view-order" style="background:#ef4444;color:#fff;font-size:12px;">\u2715 Cancel</a>';
        }
