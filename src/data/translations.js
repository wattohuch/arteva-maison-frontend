...
export const translations = {
  en: {
    ...
    gift_wrap_add: "Gift wrap this item",
    gift_wrap_added: "Gift wrapping added",
    gift_wrap_note: "Wrapped by hand. Charged once for this item.",
    gift_wrap_this: "Gift wrap this",
    gift_wrap_failed: "Could not save gift wrapping. Please try again.",
    cart_sync_failed: "We could not save your bag. Please try again.",
  ...
  ar: {
    ...
    gift_wrap_add: "تغليف هذا الصنف",
    gift_wrap_added: "تمت إضافة التغليف",
    gift_wrap_note: "تغليف يدوي. تُحتسب مرة واحدة لهذا الصنف.",
    gift_wrap_this: "تغليف هذا الصنف",
    gift_wrap_failed: "تعذّر حفظ التغليف. حاول مرة أخرى.",
    cart_sync_failed: "تعذّر حفظ سلتك. حاول مرة أخرى.",
