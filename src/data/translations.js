...
export const translations = {
  en: {
    ...
    gift_message_placeholder: "Add a message for the card (optional)",
    gift_wrap_add: "Add gift wrapping",
    gift_wrap_added: "Gift wrapping added",
    gift_wrap_note: "Wrapped by hand, once per order.",
  ...
  ar: {
    ...
    gift_wrapping: "تغليف هدية",
    gift_message_placeholder: "أضف رسالة للبطاقة (اختياري)",
    gift_wrap_add: "أضف تغليف هدية",
    gift_wrap_added: "تمت إضافة التغليف",
    gift_wrap_note: "تغليف يدوي، مرة واحدة لكل طلب.",
